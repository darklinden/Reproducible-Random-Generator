    ...
    public class ValueProcessor
    {
        ...
        public float Value
        {
            get
            {
                ...
                {
                    throw new System.Exception("ValueProcessor RandomProvider Is Null");
                }
                return RandomProvider.Random();
            }
        }
        ...
        {
            var random_value = Value;
            // Log.D("random_value: " + random_value);
            return (int)(min + (max - min + 1) * random_value);
        }
        ...
        public ulong RandULong(int index)
        {
            var random_value = RandomProvider.Random(index).value;
            // Log.D("random_value: " + random_value);
            return (ulong)(random_value * ulong.MaxValue - 1);
        }
